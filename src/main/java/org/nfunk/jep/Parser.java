...
public class Parser/*@bgen(jjtree)*/implements ParserTreeConstants, ParserConstants {/*@bgen(jjtree)*/
	 ...
	 * Addon
	 */
	private void setException(JEPTroubleI t, String... infos) {
		jep.exception = new JEPException(t, infos);
	}
	
	private void setException(JEPException ex) {
		jep.exception = ex;
	}
          ...
          jjtc001 = false;
                if (symTab.containsKey(identString)) {
                        ...
                        if (jep.allowUndeclared) {
                                ...
                                setException(JEPTrouble.JEP_UNRECOGNIZED_VARIABLE, "\""+identString+"\""); // addon
                        }
                }
    } catch (Throwable jjte001) {
          if (jjtc001) {
    ...
    try {
      identString = Identifier();
                        if (jep.funTab.containsKey(identString)) {
                                ...
                                setException(JEPTrouble.JEP_UNRECOGNIZED_FUNCTION, "\""+identString+"\""); // addon
                        }
      jj_consume_token(LRND);
      ...
      ;
        ...
        if(reqArguments == -1) {
                if(!((PostfixMathCommandI)jep.funTab.get(functionName)).checkNumberOfParameters(count))
                {
                                ...
                                new Exception("Should not occur : \n"+errorStr).printStackTrace(); // addon
                        }
        }
                        ...
                        addToErrorList(errorStr);
                        setException(JEPTrouble.JEP_ILLEGAL_NUMBER_OF_ARGUMENTS, functionName, ""+reqArguments, ""+count); // addon
                }
  }
...
*/
    ...
    default:
      ...
      throw new ParseException();
                ...
                try {
                        ...
                        if (e instanceof JEPException) // addon
                        	setException((JEPException) e); 
                }
  ...
  static private final class LookaheadSuccess extends java.lang.Error {
	  private static final long serialVersionUID = 4487186902125590674L; }
  ...
  private void jj_add_error_token(int kind, int pos) {
    ...
    if (pos == jj_endpos + 1) {
      ...
      for (java.util.Enumeration<Object> e = jj_expentries.elements(); e.hasMoreElements();) {
  ...
  public JEPException generateParseException() {
    ...
    return new JEPException(token, exptokseq, tokenImage);
  }
