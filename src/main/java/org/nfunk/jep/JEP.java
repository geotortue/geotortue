...
public class JEP {
	...
	/** Error List */
	protected Vector<Object> errorList;
	
	/** JEPException **/
	protected JEPException exception = null;
	...
	public Node parseExpression(String expression) {
		...
		catch (Exception e) 
		{
			...
			if (e instanceof ParseException) {
				...
				errorList.addElement("Syntax error : "+" "+e.getMessage());
			}
		}
	 ...
	 * @see #getComplexValue()
	 */
	public double getValue() throws JEPException {
	 ...
	 * @throws JEPException 
	 */
	public Complex getComplexValue() throws JEPException {
		Object value = getValueAsObject();
	 ...
	 */
	public Object getValueAsObject() throws JEPException {
		Object result;
