...
public class GTSVGRenderer extends SVGRenderer<GTPoint> implements GTRendererI {

	public GTSVGRenderer(RendererI<GTPoint> r, RenderJob<GTPoint> job) {
		super(r, job);
	}
